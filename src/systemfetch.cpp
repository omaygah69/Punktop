...
void ShowSystemInfo(const SystemInfo &info) {
  System::s_HostName = info.hostname;
  System::s_OS = info.os_distro;
  System::s_Kernel = info.kernel;
  System::s_Uptime = info.uptime;
  System::s_Shell = info.shell;
  System::s_Desktop = info.desktop_env;
  System::s_WindowManager = info.window_manager;
  System::s_Arch = info.arch;
  // System::s_CpuModel = info.cpu_model;

  System::s_CpuFreq = info.cpu_freq;
  // System::s_SwapDisk = info.swap_usage;
  System::s_RootDisk = info.root_total_gb;
